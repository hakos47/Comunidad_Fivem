...
CreateThread(function()
    SpawnNPC(Config.HashName, vector4(-545.52, -203.82, 37.22, 210.02))
    while true do
        ...
        if dist < 20 then
            ...
            if #(pos - vector3(Config.Cityhall.coords.x, Config.Cityhall.coords.y, Config.Cityhall.coords.z)) < 3 then
                DrawText3Ds(Config.Cityhall.coords, '~g~E~w~ - Servicios derl ayuntamiento')
...
SpawnNPC = function(modelo, x,y,z,h)
    ...
    TaskStartScenarioInPlace(crearNPC, "WORLD_HUMAN_SMOKING", 0, false)
end